...
class StockPredictionView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            # set a file name when plot is saved on os
            ...
            plt.legend()
            plt.xlim(450, 750)
            y_max = max(y_predicted) + 10
            y_min = min(y_predicted)
            plt.ylim(y_min, y_max)
            plot_image_path = f'{ticker}_final_prediction.png' 
            ...
            return Response({
                ...
                'plol_prediction': plot_prediction,
                'mse': mse,
                'rmse': rmse,
                'r2': r2,
                })